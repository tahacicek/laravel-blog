<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <!-- Topbar Search -->
            <form class="dark:bg-slate-800 d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                <div class="input-group">
                    <input type="text" class="dark:bg-slate-800 form-control bg-light border-0 small" placeholder="Search for..."
                        aria-label="Search" aria-describedby="basic-addon2">
                    <div class="dark:bg-slate-800 input-group-append">
                        <button class="dark:bg-slate-800 btn btn-primary" type="button">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <a target="_blank" href="{{ route('homepage') }}"
                    class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                        class="fas m-2 fa-blog fa-sm text-white-50"></i>Siteyi Görünütüle</a>
            </div>
